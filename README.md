...
- RSA (>= 2048 bits modulus, 17 bits exponent) and ECC (NIST P-256,
  ...
  brainpool p512r1 and curve25519) for signature, encryption and authentication;
...
## Prerequisites
- JavaCard Development Kit 3.1.0 (or above) from
  [Oracle website](http://www.oracle.com/technetwork/java/embedded/javacard/downloads/index.html);

- A device compliant with JavaCard 3.1.0 (or above) with enough
